...
export async function Header() {
  ...
  return (
    <>
      <header className="max-width flex items-center gap-4 py-4 text-sm">
        <Link
          href="/"
          className="h-8 w-8 fill-slate-700 hover:fill-red-500 dark:fill-slate-300"
        >
        ...
        <HeaderItem
          title="Name"
          content={<div className="mb-1">Joe Sanchez Jr.</div>}
        />
        {available && (
          <HeaderItem
            title="Status"
