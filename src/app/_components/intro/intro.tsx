...
export const Intro = async () => {
  ...
  return (
    <section id="intro" className="max-width mb-12 mt-2 flex flex-col xs:mt-12">
      {available && (
        <div className="mb-8 flex justify-end xs:hidden">
      ...
      <h1 className="mb-8 text-2xl font-black uppercase sm:text-4xl md:text-5xl lg:text-7xl">
        <span className="inline-block">Software Engineer,</span>
        <span className="hidden xs:inline"></span>Web
      </h1>
      <p className="max-w-[64ch] text-xl leading-snug md:self-end">
        Hello{" "}
        <span role="img" aria-label="waving hand emoji">
          👋
        </span>{" "}
        I&apos;m Joe &mdash; a creative software developer from{" "}
        <span className="inline-block">
          Texas{" "}
          <span role="img" aria-label="smiling cowboy emoji">
            🤠
          </span>
        </span>
        {` `}with{" "}
        <span className="inline-block font-semibold">seven years</span> of
        experience building for the{" "}
        <span className="inline-flex items-center gap-2">
          web{" "}
          <GlobeAltIcon className="inline h-7 w-7 text-green-400" aria-hidden />
        </span>{" "}
